...
Namespace HowToSetRelationshipsBetweenObjects.Win
	Partial Public Class HowToSetRelationshipsBetweenObjectsWindowsFormsApplication
		...
		Private Sub HowToSetRelationshipsBetweenObjectsWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
